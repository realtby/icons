...
const SelectBurger = (property: IconProps): ReturnType<React.FC> => {
  ...
  return (
    <svg viewBox="0 0 13 10" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M.003 9a1 1 0 011-1h10a1 1 0 110 2h-10a1 1 0 01-1-1zM.003 5a1 1 0 011-1h10a1 1 0 110 2h-10a1 1 0 01-1-1zM.003 1a1 1 0 011-1h10a1 1 0 110 2h-10a1 1 0 01-1-1z" />
    </svg>
  );
};
