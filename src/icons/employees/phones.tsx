...
const Phones = (property: IconProps): ReturnType<React.FC> => {
  ...
  return (
    <svg viewBox="0 0 17 16" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.15.65a.5.5 0 0 1 .7 0l1.5 1.5a.5.5 0 0 1 0 .7l-1.5 1.5a.5.5 0 1 1-.7-.7L13.8 3H9a.5.5 0 0 1 0-1h4.8l-.65-.65a.5.5 0 0 1 0-.7zm-2.3 4a.5.5 0 0 1 0 .7l-.64.65h4.8a.5.5 0 1 1 0 1h-4.8l.65.65a.5.5 0 0 1-.71.7l-1.5-1.5a.5.5 0 0 1 0-.7l1.5-1.5a.5.5 0 0 1 .7 0z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
