  ...
  return (
    <svg viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.15.646a.5.5 0 01.707 0l1.5 1.5a.5.5 0 010 .708l-1.5 1.5a.5.5 0 11-.708-.708L13.796 3H9.003a.5.5 0 010-1h4.793l-.647-.646a.5.5 0 010-.708zm-2.293 4a.5.5 0 010 .708L10.21 6h4.793a.5.5 0 110 1H10.21l.646.646a.5.5 0 01-.707.708l-1.5-1.5a.5.5 0 010-.708l1.5-1.5a.5.5 0 01.708 0z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
